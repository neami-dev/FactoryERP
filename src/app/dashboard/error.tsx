...
export default function Error({
  ...
  return (
    <>
      {/* component */}
      <div className="w-full pt-20 flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
          <p className="text-5xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">
            500
          </p>
          <p className="text-xl md:text-4xl xl:text-5xl  font-bold tracking-wider text-gray-300 mt-2">
            Erreur du serveur
          </p>
          <p className=" md:text-xl lg:text-2xl text-gray-500 my-12">
            {process.env.NODE_ENV == "production" ? "Oups, quelque chose s'est mal passé sur les serveurs." : error.message}
