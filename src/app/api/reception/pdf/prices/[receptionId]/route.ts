...
export async function GET(
  ...
  const pdfUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/reception/pdf/prices/${receptionId}`;
  ...
  return new NextResponse(pdfBuffer, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename=reception-${receptionId}-prices.pdf`,
    },
  });
}
