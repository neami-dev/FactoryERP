...
export default function NotFound() {
  return (
    <div className="w-full pt-20 md:pt-26 flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-5xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">
          404
        </p>

        <p className=" md:text-xl lg:text-2xl text-gray-500 my-12">
          Désolé, nous n&apos;avons pas pu trouver la page que vous recherchez
        </p>
        <Link
          href="/"
          className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-blue-600  hover:bg-blue-700"
        >
