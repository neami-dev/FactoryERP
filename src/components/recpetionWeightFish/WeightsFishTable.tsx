...
import deleteRepetionWeightFish from "@/lib/actions/receptionWeightFish.actions";
...
export default function WeightsFishTable({
  data,
  fishName,
  ...
  const deleteItem = async (id: number) => {
    setIsLoading(true);
    await deleteRepetionWeightFish({
      id,
    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant={"outline"}
            className=" py-5 text-base px-3   w-fit text-black cursor-pointer"
          >
            <Image
            ...
            />
            <p className="hidden md:block">les poids</p>
          </Button>
        </DialogTrigger>
