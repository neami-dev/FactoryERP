...
export function ReceptionTable<TData, TValue>({
  columns,
  data,
  ...
  const {
    ...
    queryKey: ["receptions", page, limit, supplierName],
    queryFn: async () => {
      console.log("Fetching...");
      return await getReceptions({ page, limit, lastnameOrFistname: supplierName })
    },
